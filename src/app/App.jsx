...
import { AtlasiHeroCanvas } from "../components/AtlasiHeroCanvas.jsx"
  ...
  return (
    <div className="min-h-screen" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      >
        <AtlasiHeroCanvas />
        <div
          className="absolute inset-0 opacity-[0.07] z-[5]"
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0 L45 15 L30 30 L15 15 Z M0 30 L15 45 L30 30 L15 15 Z M30 30 L45 45 L60 30 L45 15 Z M30 30 L45 45 L30 60 L15 45 Z' fill='%23C9922A' fill-rule='evenodd'/%3E%3C/svg%3E")`,
          }}
        />
        <div className="relative z-10 text-center" style={{ position: "relative", zIndex: 10 }}>
          <div className="text-[#C9922A] text-2xl mb-8">✦</div>
          <div className="relative border border-[#C9922A] px-16 py-12">
            <div className="absolute -top-1 -left-1 text-[#C9922A]">✦</div>
            <div className="absolute -top-1 -right-1 text-[#C9922A]">✦</div>
            <div className="absolute -bottom-1 -left-1 text-[#C9922A]">✦</div>
            <div className="absolute -bottom-1 -right-1 text-[#C9922A]">✦</div>
            <h1
              className="text-5xl text-[#F5EFE0] mb-3"
              style={{ fontFamily: "Playfair Display, serif", fontStyle: "italic" }}
            >
              ATLASI CAFÉ
            </h1>
            <div className="w-24 h-[1px] bg-[#C9922A] mx-auto my-3" />
            <div
              className="text-2xl text-[#C9922A]"
              style={{ fontFamily: "Vazirmatn, sans-serif", fontWeight: 700 }}
            >
              کافه اطلسی
            </div>
            <p className="text-sm text-[#F5EFE0] opacity-70 mt-4 italic">soft like silk. open like the sky.</p>
            <p className="text-sm text-[#C9922A] opacity-80" style={{ fontFamily: "Vazirmatn, sans-serif" }}>
              «نرم چون اطلس، باز چون آسمان»
            </p>
          </div>
          <div className="text-[#C9922A] text-2xl mt-8">✦</div>
        </div>
        <motion.div
        ...
        >
          <div className="w-1 h-12 bg-[#C9922A] opacity-60" />
        </motion.div>
      </section>
      ...
      <section className="bg-[#F5EFE0] border-t border-[#C9922A]">
        <div className="grid lg:grid-cols-[3fr_2fr] gap-0">
          ...
          <div className="bg-[#EDE5D0] flex flex-col items-center justify-center p-12">
            <div
              className="w-[280px] h-[280px] bg-[#2C4A3E] border border-[#C9922A] flex items-center justify-center"
              style={{
                backgroundImage: `url("data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23C9922A' fill-opacity='0.15'%3E%3Cpath d='M0 0h40v40H0V0zm40 40h40v40H40V40z'/%3E%3Cpath d='M0 40h40v40H0V40zM40 0h40v40H40V0z' transform='rotate(45 40 40)'/%3E%3C/g%3E%3C/svg%3E")`,
              }}
            >
              <div className="text-[#C9922A] text-6xl">✦</div>
            </div>
            ...
            return (
              ...
              >
                <div className="aspect-[4/5] bg-[#2C4A3E] relative p-1">
                  <div className="w-full h-full border-[3px] border-[#C9922A] flex items-center justify-center">
                    <div className="text-[#C9922A] text-5xl opacity-30">✦</div>
                  </div>
                </div>
                <div className="p-5">
                  <div
      ...
      <section ref={aboutRef} id="about" className="grid lg:grid-cols-2 min-h-[70vh]">
        <div className="bg-[#2C4A3E] p-12 flex flex-col items-center justify-center">
          <motion.div
            className="w-full max-w-md aspect-square border-[6px] border-[#C9922A] flex items-center justify-center"
            style={{ borderStyle: "double" }}
            initial={{ x: -60, opacity: 0 }}
            animate={aboutInView ? { x: 0, opacity: 1 } : { x: -60, opacity: 0 }}
            transition={{ duration: 0.9, ease }}
          >
            <div className="text-[#C9922A] text-8xl">✦</div>
          </motion.div>
