 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var x0;function BM(){if(x0)return Ta;x0=1;var n=lp(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),r=Object.prototype.hasOwnProperty,o=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function u(f,d,h){var m,v={},g=null,x=null;h!==void 0&&(g=""+h),d.key!==void 0&&(g=""+d.key),d.ref!==void 0&&(x=d.ref);for(m in d)r.call(d,m)&&!l.hasOwnProperty(m)&&(v[m]=d[m]);if(f&&f.defaultProps)for(m in d=f.defaultProps,d)v[m]===void 0&&(v[m]=d[m]);return{$$typeof:e,type:f,key:g,ref:x,props:v,_owner:o.current}}return Ta.Fragment=t,Ta.jsx=u,Ta.jsxs=u,Ta}var y0;function kM(){return y0||(y0=1,Yf.exports=BM()),Yf.exports}var de=kM(),ru={},Kf={exports:{}},qn={},$f={exports:{}},Zf={};/**
 * @license React
...
void main() {
	...
	`}class Jy extends $i{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},o=[r,r,r,r,r,r];this.texture=new Yy(o),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),h=new er(f,d),m=new $y(-1,1,1,-1,0,1);let v=null,g=null,x=!1,M,A=null,y=[],S=!1;this.setSize=function(R,b){l.setSize(R,b),u.setSize(R,b);for(let P=0;P<y.length;P++){const F=y[P];F.setSize&&F.setSize(R,b)}},this.setEffects=function(R){y=R,S=y.length>0&&y[0].isRenderPass===!0;const b=l.width,P=l.height;for(let F=0;F<y.length;F++){const L=y[F];L.setSize&&L.setSize(b,P)}},this.begin=function(R,b){if(x||R.toneMapping===Ki&&y.length===0)return!1;if(A=b,b!==null){const P=b.width,F=b.height;(l.width!==P||l.height!==F)&&this.setSize(P,F)}return S===!1&&R.setRenderTarget(l),M=R.toneMapping,R.toneMapping=Ki,!0},this.hasRenderPass=function(){return S},this.end=function(R,b){R.toneMapping=M,x=!0;let P=l,F=u;for(let L=0;L<y.length;L++){const B=y[L];if(B.enabled!==!1&&(B.render(R,F,P,b),B.needsSwap!==!1)){const T=P;P=F,F=T}}if(v!==R.outputColorSpace||g!==R.toneMapping){v=R.outputColorSpace,g=R.toneMapping,d.defines={},xt.getTransfer(v)===Dt&&(d.defines.SRGB_TRANSFER="");const L=o3[g];L&&(d.defines[L]=""),d.needsUpdate=!0}d.uniforms.tDiffuse.value=P.texture,R.setRenderTarget(A),R.render(h,m),A=null,x=!1},this.isCompositing=function(){return x},this.dispose=function(){l.depthTexture&&l.depthTexture.dispose(),l.dispose(),u.dispose(),f.dispose(),d.dispose()}}const eS=new Vn,op=new Uo(1,1),tS=new Vy,nS=new DC,iS=new Yy,S_=[],M_=[],E_=new Float32Array(16),T_=new Float32Array(9),w_=new Float32Array(4);function zo(n,e,t){const r=n[0];if(r<=0||r>0)return n;const o=e*t;let l=S_[o];if(l===void 0&&(l=new Float32Array(o),S_[o]=l),e!==0){r.toArray(l,0);for(let u=1,f=0;u!==e;++u)f+=t,n[u].toArray(l,f)}return l}function pn(n,e){if(n.length!==e.length)return!1;for(let t=0,r=n.length;t<r;t++)if(n[t]!==e[t])return!1;return!0}function mn(n,e){for(let t=0,r=e.length;t<r;t++)n[t]=e[t]}function pc(n,e){let t=M_[e];t===void 0&&(t=new Int32Array(e),M_[e]=t);for(let r=0;r!==e;++r)t[r]=n.allocateTextureUnit();return t}function l3(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function u3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pn(t,e))return;n.uniform2fv(this.addr,e),mn(t,e)}}function c3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(pn(t,e))return;n.uniform3fv(this.addr,e),mn(t,e)}}function f3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pn(t,e))return;n.uniform4fv(this.addr,e),mn(t,e)}}function d3(n,e){const t=this.cache,r=e.elements;if(r===void 0){if(pn(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),mn(t,e)}else{if(pn(t,r))return;w_.set(r),n.uniformMatrix2fv(this.addr,!1,w_),mn(t,r)}}function h3(n,e){const t=this.cache,r=e.elements;if(r===void 0){if(pn(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),mn(t,e)}else{if(pn(t,r))return;T_.set(r),n.uniformMatrix3fv(this.addr,!1,T_),mn(t,r)}}function p3(n,e){const t=this.cache,r=e.elements;if(r===void 0){if(pn(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),mn(t,e)}else{if(pn(t,r))return;E_.set(r),n.uniformMatrix4fv(this.addr,!1,E_),mn(t,r)}}function m3(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function g3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pn(t,e))return;n.uniform2iv(this.addr,e),mn(t,e)}}function v3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pn(t,e))return;n.uniform3iv(this.addr,e),mn(t,e)}}function _3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pn(t,e))return;n.uniform4iv(this.addr,e),mn(t,e)}}function x3(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function y3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(pn(t,e))return;n.uniform2uiv(this.addr,e),mn(t,e)}}function S3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(pn(t,e))return;n.uniform3uiv(this.addr,e),mn(t,e)}}function M3(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(pn(t,e))return;n.uniform4uiv(this.addr,e),mn(t,e)}}function E3(n,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(n.uniform1i(this.addr,o),r[0]=o);let l;this.type===n.SAMPLER_2D_SHADOW?(op.compareFunction=t.isReversedDepthBuffer()?Xp:Wp,l=op):l=eS,t.setTexture2D(e||l,o)}function T3(n,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(n.uniform1i(this.addr,o),r[0]=o),t.setTexture3D(e||nS,o)}function w3(n,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(n.uniform1i(this.addr,o),r[0]=o),t.setTextureCube(e||iS,o)}function A3(n,e,t){const r=this.cache,o=t.allocateTextureUnit();r[0]!==o&&(n.uniform1i(this.addr,o),r[0]=o),t.setTexture2DArray(e||tS,o)}function C3(n){switch(n){case 5126:return l3;case 35664:return u3;case 35665:return c3;case 35666:return f3;case 35674:return d3;case 35675:return h3;case 35676:return p3;case 5124:case 35670:return m3;case 35667:case 35671:return g3;case 35668:case 35672:return v3;case 35669:case 35673:return _3;case 5125:return x3;case 36294:return y3;case 36295:return S3;case 36296:return M3;case 35678:case 36198:case 36298:case 36306:case 35682:return E3;case 35679:case 36299:case 36307:return T3;case 35680:case 36300:case 36308:case 36293:return w3;case 36289:case 36303:case 36311:case 36292:return A3}}function R3(n,e){n.uniform1fv(this.addr,e)}function b3(n,e){const t=zo(e,this.size,2);n.uniform2fv(this.addr,t)}function P3(n,e){const t=zo(e,this.size,3);n.uniform3fv(this.addr,t)}function D3(n,e){const t=zo(e,this.size,4);n.uniform4fv(this.addr,t)}function L3(n,e){const t=zo(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function N3(n,e){const t=zo(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function I3(n,e){const t=zo(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function U3(n,e){n.uniform1iv(this.addr,e)}function F3(n,e){n.uniform2iv(this.addr,e)}function O3(n,e){n.uniform3iv(this.addr,e)}function B3(n,e){n.uniform4iv(this.addr,e)}function k3(n,e){n.uniform1uiv(this.addr,e)}function V3(n,e){n.uniform2uiv(this.addr,e)}function z3(n,e){n.uniform3uiv(this.addr,e)}function H3(n,e){n.uniform4uiv(this.addr,e)}function G3(n,e,t){const r=this.cache,o=e.length,l=pc(t,o);pn(r,l)||(n.uniform1iv(this.addr,l),mn(r,l));let u;this.type===n.SAMPLER_2D_SHADOW?u=op:u=eS;for(let f=0;f!==o;++f)t.setTexture2D(e[f]||u,l[f])}function W3(n,e,t){const r=this.cache,o=e.length,l=pc(t,o);pn(r,l)||(n.uniform1iv(this.addr,l),mn(r,l));for(let u=0;u!==o;++u)t.setTexture3D(e[u]||nS,l[u])}function X3(n,e,t){const r=this.cache,o=e.length,l=pc(t,o);pn(r,l)||(n.uniform1iv(this.addr,l),mn(r,l));for(let u=0;u!==o;++u)t.setTextureCube(e[u]||iS,l[u])}function j3(n,e,t){const r=this.cache,o=e.length,l=pc(t,o);pn(r,l)||(n.uniform1iv(this.addr,l),mn(r,l));for(let u=0;u!==o;++u)t.setTexture2DArray(e[u]||tS,l[u])}function Y3(n){switch(n){case 5126:return R3;case 35664:return b3;case 35665:return P3;case 35666:return D3;case 35674:return L3;case 35675:return N3;case 35676:return I3;case 5124:case 35670:return U3;case 35667:case 35671:return F3;case 35668:case 35672:return O3;case 35669:case 35673:return B3;case 5125:return k3;case 36294:return V3;case 36295:return z3;case 36296:return H3;case 35678:case 36198:case 36298:case 36306:case 35682:return G3;case 35679:case 36299:case 36307:return W3;case 35680:case 36300:case 36308:case 36293:return X3;case 36289:case 36303:case 36311:case 36292:return j3}}class q3{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.setValue=C3(t.type)}}class K3{constructor(e,t,r){this.id=e,this.addr=r,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Y3(t.type)}}class $3{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,r){const o=this.seq;for(let l=0,u=o.length;l!==u;++l){const f=o[l];f.setValue(e,t[f.id],r)}}}const Xd=/(\w+)(\])?(\[|\.)?/g;function A_(n,e){n.seq.push(e),n.map[e.id]=e}function Z3(n,e,t){const r=n.name,o=r.length;for(Xd.lastIndex=0;;){const l=Xd.exec(r),u=Xd.lastIndex;let f=l[1];const d=l[2]==="]",h=l[3];if(d&&(f=f|0),h===void 0||h==="["&&u+2===o){A_(t,h===void 0?new q3(f,n,e):new K3(f,n,e));break}else{let v=t.map[f];v===void 0&&(v=new $3(f),A_(t,v)),t=v}}}class Wu{constructor(e,t){this.seq=[],this.map={};const r=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let u=0;u<r;++u){const f=e.getActiveUniform(t,u),d=e.getUniformLocation(t,f.name);Z3(f,d,this)}const o=[],l=[];for(const u of this.seq)u.type===e.SAMPLER_2D_SHADOW||u.type===e.SAMPLER_CUBE_SHADOW||u.type===e.SAMPLER_2D_ARRAY_SHADOW?o.push(u):l.push(u);o.length>0&&(this.seq=o.concat(l))}setValue(e,t,r,o){const l=this.map[t];l!==void 0&&l.setValue(e,r,o)}setOptional(e,t,r){const o=t[r];o!==void 0&&this.setValue(e,r,o)}static upload(e,t,r,o){for(let l=0,u=t.length;l!==u;++l){const f=t[l],d=r[f.id];d.needsUpdate!==!1&&f.setValue(e,d.value,o)}}static seqWithValue(e,t){const r=[];for(let o=0,l=e.length;o!==l;++o){const u=e[o];u.id in t&&r.push(u)}return r}}function C_(n,e,t){const r=n.createShader(e);return n.shaderSource(r,t),n.compileShader(r),r}const Q3=37297;let J3=0;function e2(n,e){const t=n.split(`
`),r=[],o=Math.max(e-6,0),l=Math.min(e+6,t.length);for(let u=o;u<l;u++){const f=u+1;r.push(`${f===e?">":" "} ${f}: ${t[u]}`)}return r.join(`
`)}const R_=new ct;function t2(n){xt._getMatrix(R_,xt.workingColorSpace,n);const e=`mat3( ${R_.elements.map(t=>t.toFixed(4))} )`;switch(xt.getTransfer(n)){case ic:return[e,"LinearTransferOETF"];case Dt:return[e,"sRGBTransferOETF"];default:return st("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function b_(n,e,t){const r=n.getShaderParameter(e,n.COMPILE_STATUS),l=(n.getShaderInfoLog(e)||"").trim();if(r&&l==="")return"";const u=/ERROR: 0:(\d+)/.exec(l);if(u){const f=parseInt(u[1]);return t.toUpperCase()+`

`+l+`

`+e2(n.getShaderSource(e),f)}else return l}function n2(n,e){const t=t2(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const i2={[Ty]:"Linear",[wy]:"Reinhard",[Ay]:"Cineon",[Cy]:"ACESFilmic",[by]:"AgX",[Py]:"Neutral",[Ry]:"Custom"};function r2(n,e){const t=i2[e];return t===void 0?(st("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Du=new ie;function s2(){xt.getLuminanceCoefficients(Du);const n=Du.x.toFixed(4),e=Du.y.toFixed(4),t=Du.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function o2(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Oa).join(`
`)}function a2(n){const e=[];for(const t in n){const r=n[t];r!==!1&&e.push("#define "+t+" "+r)}return e.join(`
`)}function l2(n,e){const t={},r=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let o=0;o<r;o++){const l=n.getActiveAttrib(e,o),u=l.name;let f=1;l.type===n.FLOAT_MAT2&&(f=2),l.type===n.FLOAT_MAT3&&(f=3),l.type===n.FLOAT_MAT4&&(f=4),t[u]={type:l.type,location:n.getAttribLocation(e,u),locationSize:f}}return t}function Oa(n){return n!==""}function P_(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function D_(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const u2=/^[ \t]*#include +<([\w\d./]+)>/gm;function ap(n){return n.replace(u2,f2)}const c2=new Map;function f2(n,e){let t=pt[e];if(t===void 0){const r=c2.get(e);if(r!==void 0)t=pt[r],st('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return ap(t)}const d2=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function L_(n){return n.replace(d2,h2)}function h2(n,e,t,r){let o="";for(let l=parseInt(e);l<parseInt(t);l++)o+=r.replace(/\[\s*i\s*\]/g,"[ "+l+" ]").replace(/UNROLLED_LOOP_INDEX/g,l);return o}function N_(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}const p2={[ku]:"SHADOWMAP_TYPE_PCF",[Fa]:"SHADOWMAP_TYPE_VSM"};function m2(n){return p2[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const g2={[Us]:"ENVMAP_TYPE_CUBE",[Io]:"ENVMAP_TYPE_CUBE",[fc]:"ENVMAP_TYPE_CUBE_UV"};function v2(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":g2[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const _2={[Io]:"ENVMAP_MODE_REFRACTION"};function x2(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":_2[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const y2={[Ey]:"ENVMAP_BLENDING_MULTIPLY",[cC]:"ENVMAP_BLENDING_MIX",[fC]:"ENVMAP_BLENDING_ADD"};function S2(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":y2[n.combine]||"ENVMAP_BLENDING_NONE"}function M2(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:r,maxMip:t}}function E2(n,e,t,r){const o=n.getContext(),l=t.defines;let u=t.vertexShader,f=t.fragmentShader;const d=m2(t),h=v2(t),m=x2(t),v=S2(t),g=M2(t),x=o2(t),M=a2(l),A=o.createProgram();let y,S,R=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    `,o=new qp;o.position.z=1;const l=new kC,u=new tl(2,2),f={time:{value:1},resolution:{value:new Lt}},d=new Ii({uniforms:f,vertexShader:t,fragmentShader:r});l.add(new er(u,d));const h=new tD({antialias:!0});h.setPixelRatio(Math.min(window.devicePixelRatio,2)),e.appendChild(h.domElement);const m=()=>{const x=e.clientWidth,M=e.clientHeight;h.setSize(x,M),f.resolution.value.set(h.domElement.width,h.domElement.height)};m(),window.addEventListener("resize",m);let v;const g=()=>{v=requestAnimationFrame(g),f.time.value+=.04,h.render(l,o)};return g(),()=>{window.removeEventListener("resize",m),cancelAnimationFrame(v),e.contains(h.domElement)&&e.removeChild(h.domElement),h.dispose(),u.dispose(),d.dispose()}},[]),de.jsx("div",{ref:n,style:{position:"absolute",inset:0,width:"100%",height:"100%",overflow:"hidden",zIndex:0}})}const iD="/assets/Hero-CT5xaBV_.png",Ut=[.25,.1,.25,1],Ia={once:!0,margin:"-80px"},rD=["atlasi — from the persian atlas.","a fabric so smooth, it was worn only by those who knew the worth of softness.","a flower that blooms in every color, in every garden.","a sky that holds everything above it, quietly.","atlasi café was made for the in-between moments — warm like silk, colorful like the flower, open like the ninth sky.","somewhere you can arrive exactly as you are."],sD=[{nameEn:"TIRAMISU LATTE",nameFa:"لاته تیرامیسو",description:"layers of warmth in every sip",price:"$—"},{nameEn:"RASPBERRY & ROSE MATCHA",nameFa:"ماچای رز و تمشک",description:"bloomed with intention",price:"$—"},{nameEn:"SAFFRON & ROSE MATCHA",nameFa:"ماچای زعفران و گل",description:"a persian afternoon, iced",price:"$—"}];function oD(){const[n,e]=Je.useState(!1),t=Je.useRef(null),r=Aa(t,Ia),o=Je.useRef(null),l=Aa(o,Ia),u=Je.useRef(null),f=Aa(u,Ia),d=Je.useRef(null),h=Aa(d,Ia),m=Je.useRef(null),v=Aa(m,Ia);Je.useEffect(()=>{const M=()=>{e(window.scrollY>50)};return window.addEventListener("scroll",M),()=>window.removeEventListener("scroll",M)},[]);const g=M=>{const A=document.getElementById(M);A&&A.scrollIntoView({behavior:"smooth"})},x="born from a question.".split(" ");return de.jsxs("div",{className:"min-h-screen",style:{fontFamily:"Inter, sans-serif"},children:[de.jsxs("nav",{className:`fixed top-0 left-0 right-0 z-50 h-[72px] flex items-center justify-between px-12 transition-all duration-300 ${n?"bg-[rgba(44,74,62,0.85)] backdrop-blur-[20px] border-b border-[rgba(201,146,42,0.3)]":"bg-transparent"}`,children:[de.jsx("div",{className:"text-xl text-[#F5EFE0] cursor-pointer",style:{fontFamily:"Playfair Display, serif",fontStyle:"italic"},onClick:()=>g("hero"),children:"ATLASI"}),de.jsx("div",{className:"flex gap-10",children:[{label:"HOME",id:"hero"},{label:"MENU",id:"menu"},{label:"ABOUT",id:"about"}].map(M=>de.jsx("button",{onClick:()=>g(M.id),className:"text-xs text-[#F5EFE0] uppercase tracking-[0.2em] transition-colors duration-300 hover:text-[#C9922A]",children:M.label},M.id))})]}),de.jsxs("section",{id:"hero",className:"relative h-screen overflow-hidden",children:[de.jsx("img",{src:iD,alt:"",className:"absolute inset-0 h-full w-full object-cover",style:{zIndex:0}}),de.jsx("div",{className:"absolute inset-0 z-[1] pointer-events-none",style:{mixBlendMode:"soft-light"},children:de.jsx(nD,{})})]}),de.jsx("section",{className:"bg-[#F5EFE0] border-t border-[#C9922A]",children:de.jsxs("div",{className:"grid lg:grid-cols-[3fr_2fr] gap-0",children:[de.jsxs("div",{ref:t,className:"py-24 px-12",children:[de.jsx("div",{className:"text-xs uppercase tracking-[0.2em] text-[#8B6F47] mb-6",children:"OUR STORY — داستان ما"}),de.jsx(It.h2,{className:"text-4xl text-[#1A1A1A] leading-tight",style:{fontFamily:"Playfair Display, serif",fontStyle:"italic"},initial:{opacity:0,y:30},animate:r?{opacity:1,y:0}:{opacity:0,y:30},transition:{duration:.9,ease:Ut},children:"soft like silk. open like the sky."}),de.jsx("div",{className:"text-base text-[#8B6F47] leading-[1.9] mt-6",style:{fontWeight:300},children:rD.map((M,A)=>de.jsx(It.p,{className:A>0?"mt-3":void 0,initial:{clipPath:"inset(0 100% 0 0)"},animate:r?{clipPath:"inset(0 0% 0 0)"}:{clipPath:"inset(0 100% 0 0)"},transition:{duration:.8,delay:A*.15,ease:Ut},children:M},A))}),de.jsxs("div",{className:"flex items-center gap-2 text-[#C9922A] mt-8",children:[de.jsx(It.div,{className:"h-[1px] bg-[#C9922A] w-12 origin-left",initial:{scaleX:0},animate:r?{scaleX:1}:{scaleX:0},transition:{duration:1,delay:.5,ease:Ut}}),de.jsx("span",{children:"✦"}),de.jsx(It.div,{className:"h-[1px] bg-[#C9922A] w-12 origin-right",initial:{scaleX:0},animate:r?{scaleX:1}:{scaleX:0},transition:{duration:1,delay:.5,ease:Ut}})]}),de.jsx("div",{className:"text-2xl text-[#C9922A] mt-4",style:{fontFamily:"Vazirmatn, sans-serif"},children:"نوش جان"})]}),de.jsxs("div",{className:"bg-[#EDE5D0] flex flex-col items-center justify-center p-12",children:[de.jsx("div",{className:"w-[280px] h-[280px] bg-[#2C4A3E] border border-[#C9922A] flex items-center justify-center",style:{backgroundImage:`url("data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23C9922A' fill-opacity='0.15'%3E%3Cpath d='M0 0h40v40H0V0zm40 40h40v40H40V40z'/%3E%3Cpath d='M0 40h40v40H0V40zM40 0h40v40H40V0z' transform='rotate(45 40 40)'/%3E%3C/g%3E%3C/svg%3E")`},children:de.jsx("div",{className:"text-[#C9922A] text-6xl",children:"✦"})}),de.jsx("div",{className:"text-xs uppercase tracking-[0.2em] text-[#8B6F47] mt-4",children:"@atlasicafe"})]})]})}),de.jsxs("section",{ref:o,className:"bg-[#2C4A3E] py-24 px-6",children:[de.jsxs("div",{className:"text-center mb-16",children:[de.jsx("div",{className:"w-32 h-[1px] bg-[#C9922A] mx-auto"}),de.jsx(It.h2,{className:"text-4xl text-[#F5EFE0] my-4",style:{fontFamily:"Playfair Display, serif",fontStyle:"italic"},initial:{opacity:0,y:24},animate:l?{opacity:1,y:0}:{opacity:0,y:24},transition:{duration:.8,ease:Ut},children:"OUR FAVORITES"}),de.jsx("div",{className:"text-base text-[#C9922A]",style:{fontFamily:"Vazirmatn, sans-serif"},children:"علاقه‌مندی‌ها"}),de.jsx("div",{className:"w-32 h-[1px] bg-[#C9922A] mx-auto mt-4"})]}),de.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto",children:sD.map((M,A)=>{const y=[{initial:{x:-20,y:40,opacity:0},delay:0},{initial:{y:50,opacity:0},delay:.15},{initial:{x:20,y:40,opacity:0},delay:.3}][A];return de.jsxs(It.div,{className:"bg-[#1E3530] border border-[#C9922A]",initial:y.initial,animate:l?{x:0,y:0,opacity:1}:y.initial,transition:{duration:.7,delay:y.delay,ease:Ut},children:[de.jsx("div",{className:"aspect-[4/5] bg-[#2C4A3E] relative p-1",children:de.jsx("div",{className:"w-full h-full border-[3px] border-[#C9922A] flex items-center justify-center",children:de.jsx("div",{className:"text-[#C9922A] text-5xl opacity-30",children:"✦"})})}),de.jsxs("div",{className:"p-5",children:[de.jsx("div",{className:"text-lg text-[#F5EFE0]",style:{fontFamily:"Playfair Display, serif",fontStyle:"italic"},children:M.nameEn}),de.jsx("div",{className:"text-sm text-[#C9922A] mt-1",style:{fontFamily:"Vazirmatn, sans-serif"},children:M.nameFa}),de.jsx("div",{className:"text-xs text-[#F5EFE0] opacity-50 mt-2",style:{fontWeight:300},children:M.description}),de.jsx("div",{className:"text-sm text-[#C9922A] tracking-wider mt-3",children:M.price})]})]},A)})})]}),de.jsx("section",{id:"menu",className:"bg-[#F5EFE0] py-24 px-6",children:de.jsxs("div",{ref:u,className:"max-w-3xl mx-auto",children:[de.jsx("div",{className:"text-center mb-16",children:de.jsxs(It.div,{initial:{opacity:0,y:24},animate:f?{opacity:1,y:0}:{opacity:0,y:24},transition:{duration:.8,ease:Ut},children:[de.jsx("div",{className:"w-32 h-[1px] bg-[#C9922A] mx-auto"}),de.jsx("h2",{className:"text-4xl text-[#1A1A1A]",style:{fontFamily:"Playfair Display, serif",fontStyle:"italic"},children:"THE MENU"}),de.jsx("div",{className:"text-base text-[#C9922A] mt-1",style:{fontFamily:"Vazirmatn, sans-serif"},children:"منو"}),de.jsxs("div",{className:"flex items-center justify-center gap-2 text-[#C9922A] mt-4",children:[de.jsx("div",{className:"h-[1px] w-12 bg-[#C9922A]"}),de.jsx("span",{children:"✦"}),de.jsx("div",{className:"h-[1px] w-12 bg-[#C9922A]"})]})]})}),de.jsxs("div",{className:"mb-12",children:[de.jsx(It.div,{className:"text-xs uppercase tracking-[0.2em] text-[#2C4A3E] border-b-2 border-[#C9922A] pb-2 mb-6",initial:{opacity:0,y:12},animate:f?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.6,delay:0,ease:Ut},children:"MATCHA — ماچا"}),de.jsxs(It.div,{className:"border-b border-[#EDE5D0] py-4",initial:{x:-30,opacity:0},animate:f?{x:0,opacity:1}:{x:-30,opacity:0},transition:{duration:.6,delay:.08,ease:Ut},children:[de.jsxs("div",{className:"flex items-baseline",children:[de.jsx("div",{className:"text-xl text-[#1A1A1A]",style:{fontFamily:"Playfair Display, serif"},children:"Pistachio Cream Matcha Latte"}),de.jsx("div",{className:"flex-1 border-b border-dotted border-[#8B6F47] opacity-30 mx-4 mb-1"}),de.jsx("div",{className:"text-sm text-[#C9922A] tracking-wider",children:"$8"})]}),de.jsx("div",{className:"text-xs text-[#8B6F47] mt-1",style:{fontWeight:300},children:"matcha + agave, pistachio butter, pistachio cream top"})]}),de.jsx(It.div,{className:"border-b border-[#EDE5D0] py-4",initial:{x:-30,opacity:0},animate:f?{x:0,opacity:1}:{x:-30,opacity:0},transition:{duration:.6,delay:.16,ease:Ut},children:de.jsxs("div",{className:"flex items-baseline",children:[de.jsx("div",{className:"text-xl text-[#1A1A1A]",style:{fontFamily:"Playfair Display, serif"},children:"Raspberry & Rose Matcha"}),de.jsx("div",{className:"flex-1 border-b border-dotted border-[#8B6F47] opacity-30 mx-4 mb-1"}),de.jsx("div",{className:"text-sm text-[#C9922A] tracking-wider",children:"$—"})]})}),de.jsx(It.div,{className:"border-b border-[#EDE5D0] py-4",initial:{x:-30,opacity:0},animate:f?{x:0,opacity:1}:{x:-30,opacity:0},transition:{duration:.6,delay:.24,ease:Ut},children:de.jsxs("div",{className:"flex items-baseline",children:[de.jsx("div",{className:"text-xl text-[#1A1A1A]",style:{fontFamily:"Playfair Display, serif"},children:"Saffron & Rose Matcha"}),de.jsx("div",{className:"flex-1 border-b border-dotted border-[#8B6F47] opacity-30 mx-4 mb-1"}),de.jsx("div",{className:"text-sm text-[#C9922A] tracking-wider",children:"$—"})]})})]}),de.jsx(It.div,{className:"text-center text-[#C9922A] my-8",initial:{x:-30,opacity:0},animate:f?{x:0,opacity:1}:{x:-30,opacity:0},transition:{duration:.6,delay:.32,ease:Ut},children:"✦"}),de.jsxs("div",{className:"mb-12",children:[de.jsx(It.div,{className:"text-xs uppercase tracking-[0.2em] text-[#2C4A3E] border-b-2 border-[#C9922A] pb-2 mb-6",initial:{opacity:0,y:12},animate:f?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.6,delay:.38,ease:Ut},children:"LATTES — لاته"}),de.jsx(It.div,{className:"border-b border-[#EDE5D0] py-4",initial:{x:-30,opacity:0},animate:f?{x:0,opacity:1}:{x:-30,opacity:0},transition:{duration:.6,delay:.46,ease:Ut},children:de.jsxs("div",{className:"flex items-baseline",children:[de.jsx("div",{className:"text-xl text-[#1A1A1A]",style:{fontFamily:"Playfair Display, serif"},children:"Tiramisu Latte"}),de.jsx("div",{className:"flex-1 border-b border-dotted border-[#8B6F47] opacity-30 mx-4 mb-1"}),de.jsx("div",{className:"text-sm text-[#C9922A] tracking-wider",children:"$—"})]})})]}),de.jsx(It.div,{className:"text-center text-[#C9922A] my-8",initial:{x:-30,opacity:0},animate:f?{x:0,opacity:1}:{x:-30,opacity:0},transition:{duration:.6,delay:.54,ease:Ut},children:"✦"}),de.jsxs("div",{children:[de.jsx(It.div,{className:"text-xs uppercase tracking-[0.2em] text-[#2C4A3E] border-b-2 border-[#C9922A] pb-2 mb-6",initial:{opacity:0,y:12},animate:f?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.6,delay:.62,ease:Ut},children:"SPECIALS — ویژه"}),de.jsx(It.div,{className:"border-b border-[#EDE5D0] py-4",initial:{x:-30,opacity:0},animate:f?{x:0,opacity:1}:{x:-30,opacity:0},transition:{duration:.6,delay:.7,ease:Ut},children:de.jsxs("div",{className:"flex items-baseline",children:[de.jsx("div",{className:"text-xl text-[#1A1A1A]",style:{fontFamily:"Playfair Display, serif"},children:"Seasonal Special"}),de.jsx("div",{className:"flex-1 border-b border-dotted border-[#8B6F47] opacity-30 mx-4 mb-1"}),de.jsx("div",{className:"text-sm text-[#C9922A] tracking-wider italic",children:"ask us!"})]})})]})]})}),de.jsxs("section",{ref:d,id:"about",className:"grid lg:grid-cols-2 min-h-[70vh]",children:[de.jsxs("div",{className:"bg-[#2C4A3E] p-12 flex flex-col items-center justify-center",children:[de.jsx(It.div,{className:"w-full max-w-md aspect-square border-[6px] border-[#C9922A] flex items-center justify-center",style:{borderStyle:"double"},initial:{x:-60,opacity:0},animate:h?{x:0,opacity:1}:{x:-60,opacity:0},transition:{duration:.9,ease:Ut},children:de.jsx("div",{className:"text-[#C9922A] text-8xl",children:"✦"})}),de.jsx("p",{className:"text-xs text-[#C9922A] text-center mt-3 italic",style:{fontWeight:300},children:"the hands behind your cup"})]}),de.jsxs("div",{className:"bg-[#EDE5D0] flex flex-col justify-center p-16",children:[de.jsx(It.div,{className:"text-center text-[#C9922A] mb-6",initial:{opacity:0,y:16},animate:h?{opacity:1,y:0}:{opacity:0,y:16},transition:{duration:.6,ease:Ut},children:"◆◆◆"}),de.jsx("h2",{className:"text-4xl text-[#1A1A1A]",style:{fontFamily:"Playfair Display, serif",fontStyle:"italic"},children:x.map((M,A)=>de.jsx(It.span,{className:"inline-block",style:{marginRight:A<x.length-1?"0.25em":0},initial:{opacity:0,y:12},animate:h?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.5,delay:A*.07,ease:Ut},children:M},`${M}-${A}`))}),de.jsx(It.p,{className:"text-base text-[#8B6F47] leading-relaxed mt-4",style:{fontWeight:300},initial:{opacity:0,y:20},animate:h?{opacity:1,y:0}:{opacity:0,y:20},transition:{duration:.8,delay:.3,ease:Ut},children:"Atlasi Café began as a search for softness in a fast world. Like the atlas flower that blooms in every color, we welcome every person, every mood, every moment. Come as you are. Stay as long as you need."}),de.jsx(It.p,{className:"text-sm text-[#8B6F47] mt-4",dir:"rtl",style:{fontFamily:"Vazirmatn, sans-serif"},initial:{scale:.85,opacity:0},animate:h?{scale:1,opacity:1}:{scale:.85,opacity:0},transition:{duration:1.4,ease:Ut},children:"کافه اطلسی برای لحظه‌های میان‌راهی ساخته شد."}),de.jsxs("div",{className:"flex items-center gap-2 text-[#C9922A] mt-8",children:[de.jsx("div",{className:"h-[1px] w-12 bg-[#C9922A]"}),de.jsx("span",{children:"✦"}),de.jsx("div",{className:"h-[1px] w-12 bg-[#C9922A]"})]}),de.jsx("div",{className:"text-xs uppercase tracking-[0.2em] text-[#2C4A3E] mt-6",children:"@atlasicafe"})]})]}),de.jsxs("footer",{ref:m,className:"bg-[#1E3530] border-t border-[#C9922A] py-20 text-center",children:[de.jsxs(It.div,{initial:{opacity:0,y:20},animate:v?{opacity:1,y:0}:{opacity:0,y:20},transition:{duration:.8,ease:Ut},children:[de.jsx("div",{className:"text-[#C9922A] text-4xl mb-6",children:"✦"}),de.jsx("h3",{className:"text-3xl text-[#F5EFE0]",style:{fontFamily:"Playfair Display, serif",fontStyle:"italic"},children:"ATLASI CAFÉ"}),de.jsx("div",{className:"text-base text-[#C9922A] mt-1",style:{fontFamily:"Vazirmatn, sans-serif"},children:"کافه اطلسی"})]}),de.jsxs(It.div,{className:"flex items-center justify-center gap-2 text-[#C9922A] mt-6",initial:{opacity:0,y:12},animate:v?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.6,delay:.12,ease:Ut},children:[de.jsx("div",{className:"h-[1px] w-12 bg-[#C9922A]"}),de.jsx("span",{children:"✦"}),de.jsx("div",{className:"h-[1px] w-12 bg-[#C9922A]"})]}),de.jsx(It.p,{className:"text-sm text-[#F5EFE0] opacity-60 mt-4 italic",style:{fontFamily:"Playfair Display, serif"},initial:{opacity:0,y:12},animate:v?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.6,delay:.24,ease:Ut},children:"soft like silk. open like the sky."}),de.jsx(It.div,{className:"text-xs uppercase tracking-[0.2em] text-[#C9922A] mt-6",initial:{opacity:0,y:12},animate:v?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.6,delay:.36,ease:Ut},children:"@atlasicafe"}),de.jsx(It.div,{className:"text-2xl text-[#C9922A] mt-4",style:{fontFamily:"Vazirmatn, sans-serif"},animate:{scale:[1,1.04,1]},transition:{delay:4,duration:.6,ease:Ut,times:[0,.5,1]},children:"نوش جان"}),de.jsx(It.div,{className:"text-xs text-[#F5EFE0] opacity-30 mt-8",initial:{opacity:0,y:12},animate:v?{opacity:1,y:0}:{opacity:0,y:12},transition:{duration:.6,delay:.48,ease:Ut},children:"© 2025 Atlasi Café"})]})]})}XM.createRoot(document.getElementById("root")).render(de.jsx(oD,{}));
